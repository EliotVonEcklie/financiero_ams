<template>
    <Layout :tenant="tenant" v-slot="{ login, showModal, hideModal }">
        ...
        <div class="xl:mt-36 md:mt-48 mx-auto container">
            <h2 class="text-2xl md:text-5xl text-center font-medium text-gray-900 dark:text-white mb-8 mt-5">Impuesto predial unificado</h2>
            <!--Información predio-->
            ...
            <div class="flex justify-center items-center space-x-6 rtl:space-x-reverse mt-5">
                <button type="button" data-modal-target="modalBuscar" data-modal-toggle="modalBuscar" class="lg:w-auto md:w-full py-2.5 px-5 lg:text-sm md:text-4xl font-medium text-blue-600 border border-blue-600 bg-white hover:text-white hover:bg-blue-600 focus:outline-none rounded-lg dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700 dark:hover:border-blue-700">Buscar</button>
            </div>
                ...
                <div id="options-tab-content">
                    <div class="hidden rounded-lg bg-white dark:bg-gray-800" id="periodos" role="tabpanel" aria-labelledby="periodos-tab">
                        <div class="flex flex-wrap justify-start lg:space-x-3 md:space-x-0 md:mt-10 lg:space-y-0 md:space-y-6">
                            ...
                            <button type="button" @click="createPazSalvo" class="cursor-not-allowed flex lg:justify-between md:justify-center md:w-full lg:w-auto lg:space-x-3 md:space-x-6 items-center text-gray-300 bg-gray-100  font-bold rounded-lg lg:text-sm md:text-4xl px-2 py-2.5 dark:border dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600">
