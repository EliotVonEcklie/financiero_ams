            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <tbody>
                    <tr class="bg-gray-300 border-gray-200 dark: dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                        <td colspan="8" class="text-black text-base py-2"><p class="px-5 py-2 font-bold">Información predial</p></td>
                    </tr>
                    <tr>
            ...
            <div id="options-tab-content">
                <div class="hidden rounded-lg bg-white dark:bg-gray-800" id="periodos" role="tabpanel" aria-labelledby="periodos-tab">
                    <div class="flex justify-start space-x-3">
                        <button type="button" data-modal-target="modalPse" data-modal-toggle="modalPse" class="flex justify-between space-x-3 items-center text-white bg-bluep hover:bg-blue-400 font-bold rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:border dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        ...
                        <button type="button"  class="flex justify-between space-x-3 items-center text-white bg-bluep hover:bg-blue-400  font-bold rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:border dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        ...
                        <button type="button" @click="createEstadoCuenta" class="flex justify-between space-x-3 items-center text-white bg-bluep hover:bg-blue-400  font-bold rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:border dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        ...
                        <button type="button" disabled @click="createPazySalvo" class="cursor-not-allowed flex justify-between space-x-3 items-center text-gray-300 bg-gray-100  font-bold rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:border dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
