            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <tbody>
                    <tr class="bg-gray-200 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                        <td colspan="8" class="text-base py-2"><p class="px-5 py-2 font-bold">Información predial</p></td>
                    </tr>
                    <tr>
                        ...
                        <td class="border-b border-gray-300 text-bold text-black  bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Dirección del predio:</p>
                    ...
                    <tr class="bg-gray-200 border-gray-200 dark: dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                        <td colspan="8" class="text-base py-2"><p class="px-5 py-2 font-bold">Información del propietario</p></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="bg-gray-200 border-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                        <td colspan="8" class="text-base py-2"><p class="px-5 py-2 font-bold">Información Terreno y clasificación</p></td>
                    </tr>
                    ...
                    <tr class="text-center border-b border-gray-200 dark:border-gray-700">
                        <td colspan="8" class="py-4 text-center">
                            <div class="flex justify-center items-center space-x-6 rtl:space-x-reverse">
                                <button type="button" data-modal-target="modalBuscar" data-modal-toggle="modalBuscar" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-bluep rounded-lg dark:bg-blue-500 dark:hover:bg-blue-700">Buscar</button>
                            </div>
                        </td>
                    </tr>
                </tbody>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-2 py-4 font-bold dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base dark:text-white">{{ formatNumber(getTotal().total) }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
