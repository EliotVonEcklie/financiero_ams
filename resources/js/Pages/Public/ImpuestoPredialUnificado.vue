...
<template>
    <Layout>
        ...
        <div class="mt-5 relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <tbody>
                    <tr class="text-center bg-bluep border-b border-gray-200 dark: dark:border-gray-700 dark:bg-gray-700 dark:text-white">
                        <td colspan="8" class="text-white text-2xl py-2">Información predial</td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Código catastral:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.codigo_catastro }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold dark:text-gray-400">Total:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.total }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold dark:text-gray-400">Orden:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.orden }}</p>
                        </td>
                    </tr>
                    <hr>
                    <tr>
                        ...
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Tasa de interés mes actual:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.interes_vigente }} %</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Tasa predial vigente:</p>
                        </td>
                        <td v-if="predio != ''">
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.vigencias[0].tasa_por_mil }} x Mil</p>
                        </td >
                        <td v-else>
                            <p class="px-5 py-2 text-base text-black "></p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Descuento:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.descuento_vigente }} %</p>
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                        ...
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ showCharacters(predio.nombre_propietario) }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Documento:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ showCharacters(predio.documento) }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Dirección:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{ showCharacters(predio.direccion) }}</p>
                        </td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700">
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                        ...
                        <td >
                            <p v-if="predio != ''" class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.hectareas+"Ha - "+predio.metros_cuadrados+" m²" }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Área construida:</p>
                        </td>
                        <td>
                            <p v-if="predio != ''" class="px-5 py-2 text-base text-black dark:text-gray-400">{{ predio.area_construida+" m²" }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold">Tipo de predio:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-base text-black dark:text-gray-400">{{predio.predio_tipo }}</p>
                        </td>
                        <td class="text-bold text-black  bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                            <p class="px-5 py-2 font-bold ">Destino socioeconómico:</p>
                        </td>
                        <td>
                            <p class="px-5 py-2 text-black dark:text-gray-400">Habitacional</p>
                        </td>
                    </tr>
                        ...
                        <tbody>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                ...
                                <td class="px-2 py-4 dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().predial) }}</p>
                                </td>
                                <td v-if="predio !='' && predio.vigencias[0].estatuto.bomberil" class="px-2 py-4 dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().bomberil) }}</p>
                                </td>
                                <td v-if="predio !='' && predio.vigencias[0].estatuto.ambiental" class="px-2 py-4 dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().ambiental) }}</p>
                                </td>
                                <td v-if="predio !='' && predio.vigencias[0].estatuto.alumbrado" class="px-2 py-4 dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().alumbrado) }}</p>
                                </td>
                                <td class="px-2 py-4 dark:bg-gray-800">
                                        <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().intereses) }}</p>
                                </td>
                                <td class="px-2 py-4  dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().descuentos) }}</p>
                                </td>
                                <td class="px-2 py-4 dark:bg-gray-800">
                                    <p class="px-5 py-2 text-base ">{{ formatNumber(getTotal().total) }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
