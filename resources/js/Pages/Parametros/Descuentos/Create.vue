...
function onToggleEsNacional() {
    ...
    form.hasta = form.es_nacional ? null : ''
}
</script>

<template>
    <Layout title="Crear Descuento">
        <form @submit.prevent="form.post(route('descuentos.store'))" class="max-w-sm mx-auto">
            <label class="mb-5 relative inline-flex items-center cursor-pointer">
